package co.tpcreative.presentation.common.helper

import android.content.Context
import android.os.Environment
import co.tpcreative.presentation.common.extension.encodeBase64
import co.tpcreative.presentation.common.ImmutablePair
import co.tpcreative.presentation.common.SizeUnit
import co.tpcreative.presentation.common.Utils
import co.tpcreative.presentation.common.Utils.log
import co.tpcreative.presentation.common.encrypt.EncryptConfiguration
import co.tpcreative.presentation.common.encrypt.SecurityUtil
import java.io.*
import java.util.*
...
//        }
    ...
    private fun getConfigurationFile(): EncryptConfiguration? {
        getSecretKey()?.let {
            configurationFile = EncryptConfiguration.Builder()
                ...
                .build()
            log(this::class.java, "config files")
    ...
    fun createFileByteDataNoEncrypt(context: Context, data: ByteArray?)  : File {
        ...
        try {
            ...
            log(this::class.java, "Cannot write to $file")
        } finally {
            if (os != null) {
                try {
                    os.close()
    ...
    fun readFile(path: String?): ByteArray? {
        ...
        return try {
            ...
            log(this::class.java, "Failed to read file to input stream ${e.message}")
            null
        }
    }
    ...
    fun createFile(path: String?, content: ByteArray?): Boolean {
        ...
        try {
            ...
            log(this::class.java, "Failed create file $e")
            return false
        } finally {
            if (stream != null) {
                try {
    ...
    fun readFile(stream: FileInputStream): ByteArray? {
        ...
        try {
            ...
            log(this::class.java, "Failed on reading file from storage while the locking Thread ${e.message}")
            return null
        }
