package co.tpcreative.presentation.common.encrypt
...
class EncryptConfiguration private constructor(builder: Builder) : Any() {
    ...
    class Builder {
        ...
        fun setEncryptContent(ivx: String, secretKey: String, salt: ByteArray?): Builder {
            ...
            try {
                ...
                log(this::class.java,"UnsupportedEncodingException ${e.message}")
            }
            ...
            try {
				 ...
				 */
                val keySpec: KeySpec = PBEKeySpec(secretKey.toCharArray(), salt,
                    SecurityUtil.iterationCount,
                ...
                log(this::class.java,"InvalidKeySpecException ${e.message}")
            } catch (e: NoSuchAlgorithmException) {
                log(this::class.java,"NoSuchAlgorithmException ${e.message}")
            }
            return this
        }
