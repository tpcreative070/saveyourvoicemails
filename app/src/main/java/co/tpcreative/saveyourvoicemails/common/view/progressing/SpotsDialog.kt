...
import co.tpcreative.saveyourvoicemails.databinding.ActivitySpotsDialogBinding
...
class SpotsDialog  private constructor(context: Context?, dotColorId: Int, message: String, theme: Int, cancelable: Boolean, cancelListener: DialogInterface.OnCancelListener?) : AlertDialog(context!!, theme) {
    ...
    private lateinit var binding: ActivitySpotsDialogBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySpotsDialogBinding.inflate(layoutInflater)
        setContentView(
            binding.apply {
            }.root
        )
    ...
    private fun initMessage() {
        if (message != null && message!!.isNotEmpty()) {
           binding.dmaxSpotsTitle.text = message
        }
    }

    private fun initProgress(){
        val progress: ProgressLayout = binding.dmaxSpotsProgress
